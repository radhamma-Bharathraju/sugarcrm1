<?php 
 $GLOBALS["dictionary"]["pmse_BpmFormAction"]=array (
  ...
  array (
    ...
    'date_modified' => 
    array (
      'name' => 'idx_pmse_bpm_form_action_del_d_m',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'deleted',
    ...
    'date_entered' => 
    array (
      'name' => 'idx_pmse_bpm_form_action_del_d_e',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'deleted',
    ...
    'sync_key' => 
    array (
      'name' => 'idx_pmse_bpm_form_action_skey',
      'type' => 'unique',
      'fields' => 
      array (
        0 => 'sync_key',
  ...
  array (
    ...
    'pmse_bpmformaction_audit' => 
    array (
      'lhs_module' => 'pmse_BpmFormAction',
      'lhs_table' => 'pmse_bpm_form_action',
      'lhs_key' => 'id',
      'rhs_module' => 'Audit',
      'rhs_table' => 'pmse_bpm_form_action_audit',
      'rhs_key' => 'parent_id',
      'relationship_type' => 'one-to-many',
    ),
