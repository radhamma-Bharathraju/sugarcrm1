<?php 
 $GLOBALS["dictionary"]["pmse_BpmnGateway"]=array (
  ...
  array (
    ...
    'pmse_bpmngateway_audit' => 
    array (
      'lhs_module' => 'pmse_BpmnGateway',
      'lhs_table' => 'pmse_bpmn_gateway',
      'lhs_key' => 'id',
      'rhs_module' => 'Audit',
      'rhs_table' => 'pmse_bpmn_gateway_audit',
      'rhs_key' => 'parent_id',
      'relationship_type' => 'one-to-many',
    ),
  ...
  array (
    ...
    'date_modified' => 
    array (
      'name' => 'idx_pmse_bpmn_gateway_del_d_m',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'deleted',
    ...
    'date_entered' => 
    array (
      'name' => 'idx_pmse_bpmn_gateway_del_d_e',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'deleted',
    ...
    'sync_key' => 
    array (
      'name' => 'idx_pmse_bpmn_gateway_skey',
      'type' => 'unique',
      'fields' => 
      array (
        0 => 'sync_key',
