<?php 
 $GLOBALS["dictionary"]["HintEnrichFieldConfig"]=array (
  ...
  array (
    ...
    array (
      'name' => 'id',
      'vname' => 'LBL_HINT_ENRICH_FIELD_USER_ID',
      'type' => 'id',
      'required' => true,
      'reportable' => true,
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'hintenrichfieldconfigs_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'hintenrichfieldconfigs_modified_user',
    ...
    array (
      'name' => 'activities',
      'type' => 'link',
      'relationship' => 'hintenrichfieldconfig_activities',
    ...
    array (
      'name' => 'following_link',
      'type' => 'link',
      'relationship' => 'hintenrichfieldconfigs_following',
      'source' => 'non-db',
      'vname' => 'LBL_FOLLOWING',
      'reportable' => false,
    ),
    ...
    array (
      'name' => 'favorite_link',
      'type' => 'link',
      'relationship' => 'hintenrichfieldconfigs_favorite',
      'source' => 'non-db',
      'vname' => 'LBL_FAVORITE',
      'reportable' => false,
      'workflow' => false,
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'hintenrichfieldconfigs_assigned_user',
  ...
  array (
    'id' => 
    array (
      'name' => 'idx_hintenrichfieldconfigs_pk',
      'type' => 'primary',
      'fields' => 
      array (
        0 => 'id',
    ...
    'date_modified' => 
    array (
      'name' => 'idx_hint_enrich_field_config_del_d_m',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'deleted',
    ...
    'deleted' => 
    array (
      'name' => 'idx_hint_enrich_field_config_id_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'id',
    ...
    'date_entered' => 
    array (
      'name' => 'idx_hint_enrich_field_config_del_d_e',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'deleted',
    ...
    'name_del' => 
    array (
      'name' => 'idx_hint_enrich_field_config_name_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'name',
    ...
    'sync_key' => 
    array (
      'name' => 'idx_hint_enrich_field_config_skey',
      'type' => 'unique',
      'fields' => 
      array (
        0 => 'sync_key',
    ...
    'assigned_user_id' => 
    array (
      'name' => 'idx_hint_enrich_field_config_assigned_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'assigned_user_id',
  ...
  array (
    ...
    'hintenrichfieldconfigs_audit' => 
    array (
      'lhs_module' => 'HintEnrichFieldConfigs',
      'lhs_table' => 'hint_enrich_field_config',
      'lhs_key' => 'id',
      'rhs_module' => 'Audit',
      'rhs_table' => 'hint_enrich_field_config_audit',
      'rhs_key' => 'parent_id',
      'relationship_type' => 'one-to-many',
    ),
