<?php 
 $GLOBALS["dictionary"]["HintNewsNotification"]=array (
  ...
  array (
    ...
    array (
      'name' => 'id',
      'vname' => 'LBL_HINT_NEWS_NOTIFICATIONS_ID',
      'type' => 'id',
      'required' => true,
      'reportable' => true,
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'hintnewsnotifications_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'hintnewsnotifications_modified_user',
    ...
    array (
      'name' => 'activities',
      'type' => 'link',
      'relationship' => 'hintnewsnotification_activities',
    ...
    array (
      'name' => 'following_link',
      'type' => 'link',
      'relationship' => 'hintnewsnotifications_following',
      'source' => 'non-db',
      'vname' => 'LBL_FOLLOWING',
      'reportable' => false,
    ),
    ...
    array (
      'name' => 'favorite_link',
      'type' => 'link',
      'relationship' => 'hintnewsnotifications_favorite',
      'source' => 'non-db',
      'vname' => 'LBL_FAVORITE',
      'reportable' => false,
      'workflow' => false,
    ...
    array (
      ...
      'vname' => 'LBL_HINT_NEWS_NOTIFICATIONS_USER_ID',
    ...
    array (
      ...
      'vname' => 'LBL_HINT_NEWS_NOTIFICATIONS_USER_NAME',
      'rname' => 'full_name',
      'type' => 'relate',
      'reportable' => false,
      'source' => 'non-db',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'hintnewsnotifications_assigned_user',
  ...
  array (
    'id' => 
    array (
      'name' => 'idx_hintnewsnotifications_pk',
      'type' => 'primary',
      'fields' => 
      array (
        0 => 'id',
    ...
    'date_modified' => 
    array (
      'name' => 'idx_hint_news_notifications_del_d_m',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'deleted',
    ...
    'deleted' => 
    array (
      'name' => 'idx_hint_news_notifications_id_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'id',
    ...
    'date_entered' => 
    array (
      'name' => 'idx_hint_news_notifications_del_d_e',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'deleted',
    ...
    'name_del' => 
    array (
      'name' => 'idx_hint_news_notifications_name_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'name',
    ...
    'sync_key' => 
    array (
      'name' => 'idx_hint_news_notifications_skey',
      'type' => 'unique',
      'fields' => 
      array (
        0 => 'sync_key',
    ...
    'assigned_user_id' => 
    array (
      'name' => 'idx_hint_news_notifications_assigned_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'assigned_user_id',
  ...
  array (
    ...
    'hintnewsnotifications_audit' => 
    array (
      'lhs_module' => 'HintNewsNotifications',
      'lhs_table' => 'hint_news_notifications',
      'lhs_key' => 'id',
      'rhs_module' => 'Audit',
      'rhs_table' => 'hint_news_notifications_audit',
      'rhs_key' => 'parent_id',
      'relationship_type' => 'one-to-many',
    ),
