<?php 
 $GLOBALS["dictionary"]["PushNotification"]=array (
  ...
  array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'pushnotifications_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'pushnotifications_modified_user',
    ...
    array (
      'name' => 'activities',
      'type' => 'link',
      'relationship' => 'pushnotification_activities',
    ...
    array (
      'name' => 'following_link',
      'type' => 'link',
      'relationship' => 'pushnotifications_following',
      'source' => 'non-db',
      'vname' => 'LBL_FOLLOWING',
      'reportable' => false,
    ),
    ...
    array (
      'name' => 'favorite_link',
      'type' => 'link',
      'relationship' => 'pushnotifications_favorite',
      'source' => 'non-db',
      'vname' => 'LBL_FAVORITE',
      'reportable' => false,
      'workflow' => false,
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'pushnotifications_assigned_user',
  ...
  array (
    ...
    'pushnotification_activities' => 
    array (
      'lhs_module' => 'PushNotifications',
      'lhs_table' => 'push_notifications',
      'lhs_key' => 'id',
      ...
      'relationship_role_column_value' => 'PushNotifications',
    ),
    'pushnotifications_following' => 
    array (
      'lhs_module' => 'Users',
      'lhs_table' => 'users',
      'lhs_key' => 'id',
    ...
    'pushnotifications_locked_fields' => 
    array (
      'lhs_module' => 'PushNotifications',
      'lhs_table' => 'push_notifications',
      'lhs_key' => 'id',
    ...
    'pushnotifications_audit' => 
    array (
      'lhs_module' => 'PushNotifications',
      'lhs_table' => 'push_notifications',
      'lhs_key' => 'id',
      'rhs_module' => 'Audit',
      'rhs_table' => 'push_notifications_audit',
      'rhs_key' => 'parent_id',
      'relationship_type' => 'one-to-many',
    ),
    'pushnotifications_assigned_user' => 
    array (
      'lhs_module' => 'Users',
      'lhs_table' => 'users',
      'lhs_key' => 'id',
  ...
  array (
    ...
    'date_modified' => 
    array (
      'name' => 'idx_push_notifications_del_d_m',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'deleted',
    ...
    'deleted' => 
    array (
      'name' => 'idx_push_notifications_id_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'id',
    ...
    'date_entered' => 
    array (
      'name' => 'idx_push_notifications_del_d_e',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'deleted',
    ...
    'name_del' => 
    array (
      'name' => 'idx_push_notifications_name_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'name',
    ...
    'sync_key' => 
    array (
      'name' => 'idx_push_notifications_skey',
      'type' => 'unique',
      'fields' => 
      array (
        0 => 'sync_key',
    ...
    'assigned_user_id' => 
    array (
      'name' => 'idx_push_notifications_assigned_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'assigned_user_id',
