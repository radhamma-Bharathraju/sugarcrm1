<?php 
 $GLOBALS["dictionary"]["Calendar"]=array (
  'table' => 'calendar',
  'audited' => false,
  'color' => 'teal',
  ...
  array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'calendar_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'calendar_modified_user',
    ...
    array (
      'name' => 'activities',
      'type' => 'link',
      'relationship' => 'calendar_activities',
    ...
    array (
      'name' => 'following_link',
      'type' => 'link',
      'relationship' => 'calendar_following',
      'source' => 'non-db',
      'vname' => 'LBL_FOLLOWING',
      'reportable' => false,
    ),
    ...
    array (
      'name' => 'favorite_link',
      'type' => 'link',
      'relationship' => 'calendar_favorite',
      'source' => 'non-db',
      'vname' => 'LBL_FAVORITE',
      'reportable' => false,
      'workflow' => false,
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'calendar_team_count_relationship',
      'link_type' => 'one',
      'module' => 'Teams',
      'bean_name' => 'TeamSet',
      'source' => 'non-db',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'calendar_assigned_user',
  ...
  array (
    ...
    'acl_team_set_calendar' => 
    array (
      'name' => 'idx_calendar_acl_tmst_id',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'acl_team_set_id',
    ...
    'assigned_user_id' => 
    array (
      'name' => 'idx_calendar_assigned_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'assigned_user_id',
