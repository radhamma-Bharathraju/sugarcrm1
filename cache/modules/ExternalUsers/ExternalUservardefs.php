<?php 
 $GLOBALS["dictionary"]["ExternalUser"]=array (
  ...
  array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'externalusers_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'externalusers_modified_user',
    ...
    array (
      'name' => 'activities',
      'type' => 'link',
      'relationship' => 'externaluser_activities',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'externalusers_email_addresses_primary',
      'source' => 'non-db',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'externalusers_email_addresses',
      'source' => 'non-db',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'externalusers_assigned_user',
    ...
    array (
      'name' => 'team_link',
      'type' => 'link',
      'relationship' => 'externalusers_team',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'externalusers_team_count_relationship',
      'link_type' => 'one',
      'module' => 'Teams',
      'bean_name' => 'TeamSet',
      'source' => 'non-db',
    ...
    array (
      'name' => 'teams',
      'type' => 'link',
      'relationship' => 'externalusers_teams',
    ...
    array (
      'name' => 'following_link',
      'type' => 'link',
      'relationship' => 'externalusers_following',
      'source' => 'non-db',
      'vname' => 'LBL_FOLLOWING',
      'reportable' => false,
    ),
    ...
    array (
      'name' => 'favorite_link',
      'type' => 'link',
      'relationship' => 'externalusers_favorite',
      'source' => 'non-db',
      'vname' => 'LBL_FAVORITE',
      'reportable' => false,
      'workflow' => false,
  ...
  array (
    0 => 
    array (
      'name' => 'idx_externalusers_last_first',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'last_name',
    ...
    1 => 
    array (
      'name' => 'idx_externalusers_first_last',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'first_name',
    ...
    'date_modified' => 
    array (
      'name' => 'idx_external_users_del_d_m',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'deleted',
    ...
    'deleted' => 
    array (
      'name' => 'idx_external_users_id_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'id',
    ...
    'date_entered' => 
    array (
      'name' => 'idx_external_users_del_d_e',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'deleted',
    ...
    'name_del' => 
    array (
      'name' => 'idx_external_users_name_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'name',
    ...
    'assigned_user_id' => 
    array (
      'name' => 'idx_external_users_assigned_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'assigned_user_id',
    ...
    'team_set_external_users' => 
    array (
      'name' => 'idx_external_users_tmst_id',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'team_set_id',
    ...
    'acl_team_set_external_users' => 
    array (
      'name' => 'idx_external_users_acl_tmst_id',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'acl_team_set_id',
  ...
  'relationships' => 
  array (
    'externalusers_modified_user' => 
    array (
      'lhs_module' => 'Users',
      'lhs_table' => 'users',
      'lhs_key' => 'id',
      'rhs_module' => 'ExternalUsers',
      'rhs_table' => 'external_users',
      'rhs_key' => 'modified_user_id',
      'relationship_type' => 'one-to-many',
    ),
    'externalusers_created_by' => 
    array (
      'lhs_module' => 'Users',
      'lhs_table' => 'users',
      'lhs_key' => 'id',
    ...
    array (
      ...
      'relationship_role_column_value' => 'ExternalUsers',
    ),
    'external_user_notes' => 
    array (
      'lhs_module' => 'ExternalUsers',
    ...
    'externalusers_email_addresses' => 
    array (
      'lhs_module' => 'ExternalUsers',
      'lhs_table' => 'externalusers',
      'lhs_key' => 'id',
    ...
    'externalusers_email_addresses_primary' => 
    array (
      'lhs_module' => 'ExternalUsers',
      'lhs_table' => 'externalusers',
      'lhs_key' => 'id',
    ...
    array (
      ...
      'lhs_key' => 'id',
      'rhs_module' => 'Audit',
      'rhs_table' => 'external_users_audit',
      'rhs_key' => 'parent_id',
      'relationship_type' => 'one-to-many',
    ),
    'externalusers_assigned_user' => 
    array (
      'lhs_module' => 'Users',
      'lhs_table' => 'users',
      'lhs_key' => 'id',
    ...
    'externalusers_team_count_relationship' => 
    array (
      'lhs_module' => 'Teams',
      'lhs_table' => 'team_sets',
      'lhs_key' => 'id',
  ...
  array (
    ...
    array (
      ...
      array (
        0 => 
        array (
          'in_field_name' => 'external_id',
          'dupe_field_name' => 'external_id',
        ),
      ),
    ),
  ),
