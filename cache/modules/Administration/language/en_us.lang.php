...
$mod_strings = array (
  ...
  'ERR_UW_PACKAGE_CONVERTING' => 'Could not convert/revert package zip file.',
  ...
  'LBL_NUMBER_PINNED_MODULES_TOOLTIP' => 'We recommend setting this to a realistic number of the most frequently used modules as it is likely that a large number will not be visible in most browser sizes. Values over 100 will not be respected',
  ...
  'LBL_LDAP_ENCRYPTION_TYPE_DESC' => 'Encryption type affects whether your connection to LDAP server will be secure or not. Use None for a regular non-secure connection. Use StartTLS to enforce your regular connection to be secure. Use LDAPS for a secure connection over ldaps://',
  ...
  'LBL_MODULE_LOADER_LICENSE_WARNING' => 'The ability to <a href="{0}">upload</a> custom file packages is not available for {1}. To see which license types include this Module Loader functionality, refer to the <a href="{2}">License Types Matrix</a> documentation.',
...
',
  ...
  'WARN_LICENSE_SEATS3' => '. <p class="error">Please deactivate some users or <a target="_blank" href=\'https://support.sugarcrm.com/Resources/Contacting_SugarCRM/\'>contact us</a> to add more licenses.</p>',
  'WARN_LICENSE_SEATS3_IDM' => '. <p class="error">Please deactivate some users in <a target="_blank" href=\'%s\'>SugarIdentity</a> or <a target="_blank" href=\'https://support.sugarcrm.com/Resources/Contacting_SugarCRM/\'>contact us</a> to add more licenses.</p>',
  ...
  'WARN_LICENSE_TYPE_SEATS_EDIT_MAXED' => 'You\'re over your %s users. Please deactivate users, contact your sales representative, or email <a href="mailto:sales@sugarcrm.com">sales@sugarcrm.com</a>. For more information, refer to the <a href="https://support.sugarcrm.com/knowledge_base/license/user_types_and_sugar_licenses/">Understanding User Types, License Types, and Sugar Licenses</a> help article.',
...
For more information, refer to the <a href="https://www.sugarcrm.com/crm/product_doc.php?edition=ENT&version=7.7.0.0beta4&lang=en_us&module=LegacyGlobalSearch">Search</a> documentation.',
  ...
  'LBL_CUSTOM_API_PLATFORMS_HELP' => 'Standard platforms cannot be removed. Custom platforms added here can be removed here but custom platforms added via a module loadable package must be removed by uninstalling the package.',
...
Any integrations that rely on this platform will stop working.',
  ...
  'LBL_FTS_HOST' => 'Host',
  'LBL_FTS_PORT' => 'Port',
  'LBL_FTS_USERNAME' => 'User Name',
  'LBL_FTS_PASSWORD' => 'Password',
  'LBL_FTS_TRANSPORT' => 'Transport',
  ...
  'LBL_FTS_USER_HELP' => 'Enter the login user name for the full text search engine',
  'LBL_FTS_PASSWORD_HELP' => 'Enter the login password for the full text search engine',
  'LBL_FTS_TRANSPORT_HELP' => 'Transport method, HTTP or HTTPS',
