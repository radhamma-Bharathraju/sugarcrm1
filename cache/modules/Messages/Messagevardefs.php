<?php 
 $GLOBALS["dictionary"]["Message"]=array (
  'table' => 'messages',
  'color' => 'army',
  ...
  array (
    ...
    array (
      'name' => 'activities',
      'type' => 'link',
      'relationship' => 'message_activities',
    ...
    array (
      'name' => 'following_link',
      'type' => 'link',
      'relationship' => 'messages_following',
      'source' => 'non-db',
      'vname' => 'LBL_FOLLOWING',
      'reportable' => false,
    ),
    ...
    array (
      'name' => 'favorite_link',
      'type' => 'link',
      'relationship' => 'messages_favorite',
      'source' => 'non-db',
      'vname' => 'LBL_FAVORITE',
      'reportable' => false,
      'workflow' => false,
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'messages_assigned_user',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'messages_team_count_relationship',
      'link_type' => 'one',
      'module' => 'Teams',
      'bean_name' => 'TeamSet',
      'source' => 'non-db',
  ...
  array (
    ...
    'assigned_user_id' => 
    array (
      'name' => 'idx_messages_assigned_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'assigned_user_id',
    ...
    'acl_team_set_messages' => 
    array (
      'name' => 'idx_messages_acl_tmst_id',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'acl_team_set_id',
  ...
  array (
    ...
    'sentiments_comprehend' => 'sentiments_comprehend',
  ),
  'custom_fields' => false,
