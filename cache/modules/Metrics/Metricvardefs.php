<?php 
 $GLOBALS["dictionary"]["Metric"]=array (
  'table' => 'metrics',
  'audited' => true,
  ...
  array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'metrics_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'metrics_modified_user',
    ...
    array (
      'name' => 'activities',
      'type' => 'link',
      'relationship' => 'metric_activities',
    ...
    array (
      'name' => 'following_link',
      'type' => 'link',
      'relationship' => 'metrics_following',
      'source' => 'non-db',
      'vname' => 'LBL_FOLLOWING',
      'reportable' => false,
    ),
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'metrics_assigned_user',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'metrics_team_count_relationship',
      'link_type' => 'one',
      'module' => 'Teams',
      'bean_name' => 'TeamSet',
      'source' => 'non-db',
  ...
  array (
    ...
    array (
      ...
      'relationship_role_column_value' => 'Metrics',
    ),
    'metrics_following' => 
    array (
      'lhs_module' => 'Users',
    ...
    array (
      ...
      'lhs_key' => 'id',
      'rhs_module' => 'Audit',
      'rhs_table' => 'metrics_audit',
      'rhs_key' => 'parent_id',
      'relationship_type' => 'one-to-many',
    ),
    'metrics_assigned_user' => 
    array (
      'lhs_module' => 'Users',
      'lhs_table' => 'users',
      'lhs_key' => 'id',
    ...
    'metrics_team_count_relationship' => 
    array (
      'lhs_module' => 'Teams',
      'lhs_table' => 'team_sets',
      'lhs_key' => 'id',
  ...
  array (
    ...
    'acl_team_set_metrics' => 
    array (
      'name' => 'idx_metrics_acl_tmst_id',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'acl_team_set_id',
