<?php 
 $GLOBALS["dictionary"]["ForecastManagerWorksheet"]=array (
  ...
  array (
    ...
    'forecastmanagerworksheets_audit' => 
    array (
      'lhs_module' => 'ForecastManagerWorksheets',
      'lhs_table' => 'forecast_manager_worksheets',
      'lhs_key' => 'id',
      'rhs_module' => 'Audit',
      'rhs_table' => 'forecast_manager_worksheets_audit',
      'rhs_key' => 'parent_id',
      'relationship_type' => 'one-to-many',
    ),
  ...
  array (
    ...
    'date_modified' => 
    array (
      'name' => 'idx_forecast_manager_worksheets_del_d_m',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'deleted',
    ...
    'date_entered' => 
    array (
      'name' => 'idx_forecast_manager_worksheets_del_d_e',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'deleted',
    ...
    'sync_key' => 
    array (
      'name' => 'idx_forecast_manager_worksheets_skey',
      'type' => 'unique',
      'fields' => 
      array (
        0 => 'sync_key',
