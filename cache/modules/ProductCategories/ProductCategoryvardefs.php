<?php 
 $GLOBALS["dictionary"]["ProductCategory"]=array (
  ...
  array (
    ...
    'date_modified' => 
    array (
      'name' => 'idx_product_categories_del_d_m',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'deleted',
    ...
    'date_entered' => 
    array (
      'name' => 'idx_product_categories_del_d_e',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'deleted',
    ...
    'sync_key' => 
    array (
      'name' => 'idx_product_categories_skey',
      'type' => 'unique',
      'fields' => 
      array (
        0 => 'sync_key',
  ...
  array (
    ...
    'productcategories_audit' => 
    array (
      'lhs_module' => 'ProductCategories',
      'lhs_table' => 'product_categories',
      'lhs_key' => 'id',
      'rhs_module' => 'Audit',
      'rhs_table' => 'product_categories_audit',
      'rhs_key' => 'parent_id',
      'relationship_type' => 'one-to-many',
    ),
