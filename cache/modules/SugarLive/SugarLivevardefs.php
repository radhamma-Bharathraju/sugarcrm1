<?php 
 $GLOBALS["dictionary"]["SugarLive"]=array (
  'table' => 'sugar_live',
  ...
  array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'sugarlive_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'sugarlive_modified_user',
    ...
    array (
      'name' => 'activities',
      'type' => 'link',
      'relationship' => 'sugarlive_activities',
    ...
    array (
      'name' => 'following_link',
      'type' => 'link',
      'relationship' => 'sugarlive_following',
      'source' => 'non-db',
      'vname' => 'LBL_FOLLOWING',
      'reportable' => false,
    ),
    ...
    array (
      'name' => 'favorite_link',
      'type' => 'link',
      'relationship' => 'sugarlive_favorite',
      'source' => 'non-db',
      'vname' => 'LBL_FAVORITE',
      'reportable' => false,
      'workflow' => false,
    ...
    array (
      ...
      'relationship' => 'sugarlive_locked_fields',
      'source' => 'non-db',
      'exportable' => false,
      'duplicate_merge' => 'disabled',
    ),
  ...
  'relationships' => 
  array (
    'sugarlive_modified_user' => 
    array (
      'lhs_module' => 'Users',
      'lhs_table' => 'users',
      'lhs_key' => 'id',
      'rhs_module' => 'SugarLive',
      'rhs_table' => 'sugar_live',
      'rhs_key' => 'modified_user_id',
      'relationship_type' => 'one-to-many',
    ),
    'sugarlive_created_by' => 
    array (
      'lhs_module' => 'Users',
      'lhs_table' => 'users',
      'lhs_key' => 'id',
    ...
    'sugarlive_activities' => 
    array (
      'lhs_module' => 'SugarLive',
      'lhs_table' => 'sugar_live',
      'lhs_key' => 'id',
      ...
      'relationship_role_column_value' => 'SugarLive',
    ),
    'sugarlive_following' => 
    array (
      'lhs_module' => 'Users',
