<?php 
 $GLOBALS["dictionary"]["Call"]=array (
  ...
  array (
    ...
    'parent_call_of_call_rel' => 
    array (
      'name' => 'parent_call_of_call_rel',
      'type' => 'link',
      'relationship' => 'parent_call_of_call_rel',
      'source' => 'non-db',
      'vname' => 'LBL_PARENT_CALL_OF_CALL_REL',
      'reportable' => true,
    ),
    'parent_call_of_meeting_rel' => 
    array (
      'name' => 'parent_call_of_meeting_rel',
      'type' => 'link',
      'relationship' => 'parent_call_of_meeting_rel',
      'source' => 'non-db',
      'vname' => 'LBL_PARENT_CALL_OF_MEETING_REL',
      'reportable' => true,
    ),
    'parent_call_of_task_rel' => 
    array (
      'name' => 'parent_call_of_task_rel',
      'type' => 'link',
      'relationship' => 'parent_call_of_task_rel',
      'source' => 'non-db',
      'vname' => 'LBL_PARENT_CALL_OF_TASK_REL',
      'reportable' => true,
    ),
  ),
  'indices' => 
  array (
    ...
    'idx_del_wf_tpl_sub_subtpl_call_name' => 
    array (
      'name' => 'idx_del_wf_tpl_sub_subtpl_call_name',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'deleted',
    ...
    'idx_del_wf_tpl_sub_subtpl_call_status' => 
    array (
      'name' => 'idx_del_wf_tpl_sub_subtpl_call_status',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'deleted',
