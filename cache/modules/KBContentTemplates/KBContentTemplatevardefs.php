<?php 
 $GLOBALS["dictionary"]["KBContentTemplate"]=array (
  ...
  array (
    ...
    'kbcontenttemplates_audit' => 
    array (
      'lhs_module' => 'KBContentTemplates',
      'lhs_table' => 'kbcontent_templates',
      'lhs_key' => 'id',
      'rhs_module' => 'Audit',
      'rhs_table' => 'kbcontent_templates_audit',
      'rhs_key' => 'parent_id',
      'relationship_type' => 'one-to-many',
    ),
  ...
  array (
    ...
    'date_modified' => 
    array (
      'name' => 'idx_kbcontent_templates_del_d_m',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'deleted',
    ...
    'date_entered' => 
    array (
      'name' => 'idx_kbcontent_templates_del_d_e',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'deleted',
    ...
    'sync_key' => 
    array (
      'name' => 'idx_kbcontent_templates_skey',
      'type' => 'unique',
      'fields' => 
      array (
        0 => 'sync_key',
