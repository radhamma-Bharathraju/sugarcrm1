<?php 
 $GLOBALS["dictionary"]["DocumentTemplate"]=array (
  ...
  array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'documenttemplates_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'documenttemplates_modified_user',
    ...
    array (
      'name' => 'activities',
      'type' => 'link',
      'relationship' => 'documenttemplate_activities',
    ...
    array (
      'name' => 'following_link',
      'type' => 'link',
      'relationship' => 'documenttemplates_following',
      'source' => 'non-db',
      'vname' => 'LBL_FOLLOWING',
      'reportable' => false,
    ),
    ...
    array (
      'name' => 'favorite_link',
      'type' => 'link',
      'relationship' => 'documenttemplates_favorite',
      'source' => 'non-db',
      'vname' => 'LBL_FAVORITE',
      'reportable' => false,
      'workflow' => false,
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'documenttemplates_assigned_user',
    ...
    array (
      'name' => 'team_link',
      'type' => 'link',
      'relationship' => 'documenttemplates_team',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'documenttemplates_team_count_relationship',
      'link_type' => 'one',
      'module' => 'Teams',
      'bean_name' => 'TeamSet',
      'source' => 'non-db',
    ...
    array (
      'name' => 'teams',
      'type' => 'link',
      'relationship' => 'documenttemplates_teams',
  ...
  array (
    ...
    'documenttemplates_audit' => 
    array (
      'lhs_module' => 'DocumentTemplates',
      'lhs_table' => 'document_templates',
      'lhs_key' => 'id',
      'rhs_module' => 'Audit',
      'rhs_table' => 'document_templates_audit',
      'rhs_key' => 'parent_id',
      'relationship_type' => 'one-to-many',
    ),
  ...
  array (
    ...
    'date_modified' => 
    array (
      'name' => 'idx_document_templates_del_d_m',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'deleted',
    ...
    'deleted' => 
    array (
      'name' => 'idx_document_templates_id_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'id',
    ...
    'date_entered' => 
    array (
      'name' => 'idx_document_templates_del_d_e',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'deleted',
    ...
    'name_del' => 
    array (
      'name' => 'idx_document_templates_name_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'name',
    ...
    'sync_key' => 
    array (
      'name' => 'idx_document_templates_skey',
      'type' => 'unique',
      'fields' => 
      array (
        0 => 'sync_key',
    ...
    'assigned_user_id' => 
    array (
      'name' => 'idx_document_templates_assigned_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'assigned_user_id',
    ...
    'team_set_document_templates' => 
    array (
      'name' => 'idx_document_templates_tmst_id',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'team_set_id',
    ...
    'acl_team_set_document_templates' => 
    array (
      'name' => 'idx_document_templates_acl_tmst_id',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'acl_team_set_id',
