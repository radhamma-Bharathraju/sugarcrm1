 ...
 $GLOBALS["dictionary"]["Contact"]=array (
  ...
  array (
    ...
    array (
      ...
      'min' => false,
      'max' => false,
      'id' => '11cad530-1dd7-11f0-a6ee-acde48001122',
      'custom_module' => 'Contacts',
    ),
    'epoch_time_c' => 
    array (
      'labelValue' => 'EPOCH Time',
      'full_text_search' => 
      array (
        'enabled' => '0',
        'boost' => '1',
      ...
      'min' => false,
      'max' => false,
      'id' => '4ba5f32a-1dd7-11f0-8812-acde48001122',
      'custom_module' => 'Contacts',
    ),
    'epoch_time_utc_c' => 
    array (
      'labelValue' => 'EPOCH Time UTC',
      'full_text_search' => 
      array (
        'enabled' => '0',
        'boost' => '1',
      ...
      'readonly' => false,
      'source' => 'custom_fields',
      'name' => 'epoch_time_utc_c',
      'vname' => 'LBL_EPOCH_TIME_UTC_C',
      'type' => 'varchar',
      'massupdate' => true,
      'hidemassupdate' => false,
      'no_default' => false,
      ...
      'len' => 100,
      'size' => '20',
      'id' => '7003f5aa-1dd7-11f0-b3d5-acde48001122',
      'custom_module' => 'Contacts',
    ),
  ),
  'indices' => 
  array (
    ...
    'external_user_id' => 
    array (
      'name' => 'idx_contacts_external_user_id',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'external_user_id',
    ...
    'idx_contacts_cjtpl_id' => 
    array (
      'name' => 'idx_contacts_cjtpl_id',
      'type' => 'index',
      'fields' => 
      array (
