<?php 
 $GLOBALS["dictionary"]["HintNotificationTarget"]=array (
  ...
  array (
    ...
    array (
      'name' => 'id',
      'vname' => 'LBL_HINT_NOTIFICATION_TARGET_ID',
      'type' => 'id',
      'required' => true,
      'reportable' => true,
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'hintnotificationtargets_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'hintnotificationtargets_modified_user',
    ...
    array (
      'name' => 'activities',
      'type' => 'link',
      'relationship' => 'hintnotificationtarget_activities',
    ...
    array (
      'name' => 'following_link',
      'type' => 'link',
      'relationship' => 'hintnotificationtargets_following',
      'source' => 'non-db',
      'vname' => 'LBL_FOLLOWING',
      'reportable' => false,
    ),
    ...
    array (
      'name' => 'favorite_link',
      'type' => 'link',
      'relationship' => 'hintnotificationtargets_favorite',
      'source' => 'non-db',
      'vname' => 'LBL_FAVORITE',
      'reportable' => false,
      'workflow' => false,
    ...
    array (
      ...
      'vname' => 'LBL_HINT_NOTIFICATION_TARGET_USER_ID',
    ...
    array (
      ...
      'vname' => 'LBL_HINT_NOTIFICATION_TARGET_USER_NAME',
      'rname' => 'full_name',
      'type' => 'relate',
      'reportable' => false,
      'source' => 'non-db',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'hintnotificationtargets_assigned_user',
  ...
  array (
    'id' => 
    array (
      'name' => 'idx_hintnotificationtargets_pk',
      'type' => 'primary',
      'fields' => 
      array (
        0 => 'id',
    ...
    'date_modified' => 
    array (
      'name' => 'idx_hint_notification_targets_del_d_m',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'deleted',
    ...
    'deleted' => 
    array (
      'name' => 'idx_hint_notification_targets_id_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'id',
    ...
    'date_entered' => 
    array (
      'name' => 'idx_hint_notification_targets_del_d_e',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'deleted',
    ...
    'name_del' => 
    array (
      'name' => 'idx_hint_notification_targets_name_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'name',
    ...
    'sync_key' => 
    array (
      'name' => 'idx_hint_notification_targets_skey',
      'type' => 'unique',
      'fields' => 
      array (
        0 => 'sync_key',
    ...
    'assigned_user_id' => 
    array (
      'name' => 'idx_hint_notification_targets_assigned_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'assigned_user_id',
  ...
  array (
    ...
    'hintnotificationtargets_audit' => 
    array (
      'lhs_module' => 'HintNotificationTargets',
      'lhs_table' => 'hint_notification_targets',
      'lhs_key' => 'id',
      'rhs_module' => 'Audit',
      'rhs_table' => 'hint_notification_targets_audit',
      'rhs_key' => 'parent_id',
      'relationship_type' => 'one-to-many',
    ),
