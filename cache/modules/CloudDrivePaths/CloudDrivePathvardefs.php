<?php 
 $GLOBALS["dictionary"]["CloudDrivePath"]=array (
  ...
  array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'clouddrivepaths_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'clouddrivepaths_modified_user',
    ...
    array (
      'name' => 'activities',
      'type' => 'link',
      'relationship' => 'clouddrivepath_activities',
    ...
    array (
      'name' => 'following_link',
      'type' => 'link',
      'relationship' => 'clouddrivepaths_following',
      'source' => 'non-db',
      'vname' => 'LBL_FOLLOWING',
      'reportable' => false,
    ),
    ...
    array (
      'name' => 'favorite_link',
      'type' => 'link',
      'relationship' => 'clouddrivepaths_favorite',
      'source' => 'non-db',
      'vname' => 'LBL_FAVORITE',
      'reportable' => false,
      'workflow' => false,
  ...
  array (
    ...
    'clouddrivepaths_audit' => 
    array (
      'lhs_module' => 'CloudDrivePaths',
      'lhs_table' => 'cloud_drive_paths',
      'lhs_key' => 'id',
      'rhs_module' => 'Audit',
      'rhs_table' => 'cloud_drive_paths_audit',
      'rhs_key' => 'parent_id',
      'relationship_type' => 'one-to-many',
    ),
  ),
  ...
  array (
    ...
    'date_modified' => 
    array (
      'name' => 'idx_cloud_drive_paths_del_d_m',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'deleted',
    ...
    'deleted' => 
    array (
      'name' => 'idx_cloud_drive_paths_id_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'id',
    ...
    'date_entered' => 
    array (
      'name' => 'idx_cloud_drive_paths_del_d_e',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'deleted',
    ...
    'name_del' => 
    array (
      'name' => 'idx_cloud_drive_paths_name_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'name',
    ...
    'sync_key' => 
    array (
      'name' => 'idx_cloud_drive_paths_skey',
      'type' => 'unique',
      'fields' => 
      array (
        0 => 'sync_key',
