<?php 
 $GLOBALS["dictionary"]["DataArchiver"]=array (
  ...
  array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'dataarchiver_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'dataarchiver_modified_user',
    ...
    array (
      'name' => 'activities',
      'type' => 'link',
      'relationship' => 'dataarchiver_activities',
    ...
    array (
      'name' => 'following_link',
      'type' => 'link',
      'relationship' => 'dataarchiver_following',
      'source' => 'non-db',
      'vname' => 'LBL_FOLLOWING',
      'reportable' => false,
    ),
    ...
    array (
      'name' => 'favorite_link',
      'type' => 'link',
      'relationship' => 'dataarchiver_favorite',
      'source' => 'non-db',
      'vname' => 'LBL_FAVORITE',
      'reportable' => false,
      'workflow' => false,
    ...
    array (
      ...
      'relationship' => 'dataarchiver_locked_fields',
      'source' => 'non-db',
      'exportable' => false,
      'duplicate_merge' => 'disabled',
    ),
  ...
  array (
    ...
    array (
      ...
      'lhs_key' => 'id',
      'rhs_module' => 'Audit',
      'rhs_table' => 'data_archivers_audit',
      'rhs_key' => 'parent_id',
      'relationship_type' => 'one-to-many',
    ),
  ),
  ...
  array (
    ...
    'date_modified' => 
    array (
      'name' => 'idx_data_archivers_del_d_m',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'deleted',
    ...
    'deleted' => 
    array (
      'name' => 'idx_data_archivers_id_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'id',
    ...
    'date_entered' => 
    array (
      'name' => 'idx_data_archivers_del_d_e',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'deleted',
    ...
    'name_del' => 
    array (
      'name' => 'idx_data_archivers_name_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'name',
