...
<tr>
            ...
            {/if}
				...
				{counter name="fieldsUsed"}
		            ...
		            {if ($fields.name.acl > 1 || name == 'license_type') && $fields.name.locked == false && $fields.name.disabled == false}
	...
	{/if}
            ...
            {/if}
				...
				{counter name="fieldsUsed"}
		            ...
		            {if ($fields.status.acl > 1 || status == 'license_type') && $fields.status.locked == false && $fields.status.disabled == false}
...
<tr>
            ...
            {/if}
				...
				{counter name="fieldsUsed"}
		            ...
		            {if ($fields.job_function.acl > 1 || job_function == 'license_type') && $fields.job_function.locked == false && $fields.job_function.disabled == false}
	...
	{/if}
            ...
            {/if}
				...
				{counter name="fieldsUsed"}
		            ...
		            {if ($fields.job_url.acl > 1 || job_url == 'license_type') && $fields.job_url.locked == false && $fields.job_url.disabled == false}
...
<tr>
            ...
            {/if}
				...
				{counter name="fieldsUsed"}
		            ...
		            {if ($fields.adv_interval.acl > 1 || adv_interval == 'license_type') && $fields.adv_interval.locked == false && $fields.adv_interval.disabled == false}
...
<tr>
            ...
            {/if}
				...
				{counter name="fieldsUsed"}
		            ...
		            {if ($fields.job_interval.acl > 1 || job_interval == 'license_type') && $fields.job_interval.locked == false && $fields.job_interval.disabled == false}
...
<tr>
		...
		{sugar_help text=$MOD.LBL_CATCH_UP_WARNING}
		            {if ($fields.catch_up.acl > 1 || catch_up == 'license_type') && $fields.catch_up.locked == false && $fields.catch_up.disabled == false}
...
<tr>
            ...
            {/if}
				...
				{counter name="fieldsUsed"}
		            ...
		            {if ($fields.date_time_start.acl > 1 || date_time_start == 'license_type') && $fields.date_time_start.locked == false && $fields.date_time_start.disabled == false}
...
var combo_{$fields.date_time_start.name} = new Datetimecombo("{$fields[$fields.date_time_start.name].value}", "{$fields.date_time_start.name}", "{$TIME_FORMAT|escape:'javascript'}", "0", '', false, true);
	...
	{/if}
            ...
            {/if}
				...
				{counter name="fieldsUsed"}
		            ...
		            {if ($fields.time_from.acl > 1 || time_from == 'license_type') && $fields.time_from.locked == false && $fields.time_from.disabled == false}
...
<tr>
            ...
            {/if}
				...
				{counter name="fieldsUsed"}
		            ...
		            {if ($fields.date_time_end.acl > 1 || date_time_end == 'license_type') && $fields.date_time_end.locked == false && $fields.date_time_end.disabled == false}
...
<script type="text/javascript" src="{sugar_getjspath file="include/SugarFields/Fields/Datetimecombo/Datetimecombo.js"}"></script>
<script type="text/javascript">
var combo_{$fields.date_time_end.name} = new Datetimecombo("{$fields[$fields.date_time_end.name].value}", "{$fields.date_time_end.name}", "{$TIME_FORMAT|escape:'javascript'}", "0", '', false, true);
//Render the remaining widget fields
	...
	{/if}
            ...
            {/if}
				...
				{counter name="fieldsUsed"}
		            ...
		            {if ($fields.time_to.acl > 1 || time_to == 'license_type') && $fields.time_to.locked == false && $fields.time_to.disabled == false}
