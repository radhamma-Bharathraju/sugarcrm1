...
$mod_strings = array (
  ...
  'LBL_OW_TYPE' => 'Type',
  'LBL_RU_TEAM_FORECAST_HEADER' => 'Team Forecast for <span class="sicon sicon-user-group mx-1"></span> {{name}}',
  ...
  'LBL_FDR_FORECAST_HEADER' => 'Seller Forecast for <span class="sicon sicon-user mx-1"></span> {{name}}',
  ...
  'LBL_LOST' => 'Lost',
  'LBL_ALL' => 'All',
  'LBL_METRIC_LABEL_QUOTA' => 'Quota',
  'LBL_METRIC_LABEL_COMMITMENT' => 'Commitment',
  'LBL_METRIC_LABEL_QUOTA_COVERAGE' => 'Quota Coverage',
  'LBL_METRIC_LABEL_GAP_QUOTA' => 'Gap to Quota',
  'LBL_METRIC_LABEL_PCT_WON_QUOTA' => '% Won of Quota',
  'LBL_METRIC_LABEL_QUOTA_GAP_COVERAGE' => 'Quota Gap Coverage',
  'LBL_METRIC_LABEL_COMMITMENT_COVERAGE' => 'Commitment Coverage',
  'LBL_METRIC_LABEL_GAP_COMMITMENT' => 'Gap to Commitment',
  'LBL_METRIC_LABEL_COMMITMENT_GAP_COVERAGE' => 'Commitment Gap Coverage',
  'LBL_METRIC_LABEL_PCT_WON_COMMITMENT' => '% Won of Commitment',
  'LBL_METRIC_LABEL_FORECAST_COVERAGE' => 'Forecast Coverage',
  'LBL_METRIC_LABEL_GAP_FORECAST' => 'Gap to Forecast',
  'LBL_METRIC_LABEL_FORECAST_GAP_COVERAGE' => 'Forecast Gap Coverage',
  'LBL_METRIC_LABEL_PCT_WON_FORECAST' => '% Won of Forecast',
  ...
  'LBL_METRIC_HELP_QUOTA' => 'Quota',
  'LBL_METRIC_HELP_COMMITMENT' => 'Likely Commitment',
  'LBL_METRIC_HELP_QUOTA_COVERAGE' => '(Pipeline + Won + Lost)/Quota',
  'LBL_METRIC_HELP_GAP_QUOTA' => 'Quota – Won',
  'LBL_METRIC_HELP_PCT_WON_QUOTA' => 'Won/Quota',
  'LBL_METRIC_HELP_QUOTA_GAP_COVERAGE' => 'Pipeline / Gap to Quota',
  'LBL_METRIC_HELP_COMMITMENT_COVERAGE' => '(Pipeline + Won + Lost)/Commitment',
  'LBL_METRIC_HELP_GAP_COMMITMENT' => 'Likely Commitment - Won',
  'LBL_METRIC_HELP_COMMITMENT_GAP_COVERAGE' => 'Pipeline / Gap to Likely Commitment',
  'LBL_METRIC_HELP_PCT_WON_COMMITMENT' => 'Won/Likely Commitment',
  'LBL_METRIC_HELP_FORECAST_COVERAGE' => '(Pipeline + Won + Lost)/Forecast',
  'LBL_METRIC_HELP_GAP_FORECAST' => 'Forecast – Won (Included Pipeline)',
  'LBL_METRIC_HELP_FORECAST_GAP_COVERAGE' => 'Pipeline / Gap to Forecast',
  'LBL_METRIC_HELP_PCT_WON_FORECAST' => 'Won/Forecast',
  ...
  'LBL_COMMITTED_HISTORY_LIKELY_CHANGED' => 'Committed (Likely) {{{direction}}} {{{from}}} to {{{to}}}',
  'LBL_COMMITTED_HISTORY_BEST_CHANGED' => 'Committed (Best) {{{direction}}} {{{from}}} to {{{to}}}',
  'LBL_COMMITTED_HISTORY_WORST_CHANGED' => 'Committed (Worst) {{{direction}}} {{{from}}} to {{{to}}}',
  'LBL_COMMITTED_HISTORY_LIKELY_SAME' => 'Committed (Likely) stayed the same',
  'LBL_COMMITTED_HISTORY_BEST_SAME' => 'Committed (Best) stayed the same',
  'LBL_COMMITTED_HISTORY_WORST_SAME' => 'Committed (Worst) stayed the same',
  ...
  'LBL_OPEN_LIKELY' => 'Open Likely',
  'LBL_OPEN_BEST' => 'Open Best',
  'LBL_OPEN_WORST' => 'Open Worst',
  'LBL_PIPELINE_METRICS_DASHLET_NAME' => 'Pipeline Metrics',
  'LBL_PIPELINE_METRICS_DASHLET_DESC' => 'Display pipeline metrics details',
  'LBL_PIPELINE_METRICS_DASHLET_METRICS_GUIDE' => 'Pipeline Metrics Guide',
  'LBL_PIPELINE_METRICS_DASHLET_CONFIG_METRICS' => 'Display Metrics',
  'LBL_PIPELINE_METRICS_DASHLET_CONFIG_METRICS_GUIDE' => 'Guide on Metrics',
  'LBL_PIPELINE_METRICS_DASHLET_CONFIG_METRICS_REQUIRED' => 'Must select at least one metric to show on metric tabs',
  ...
  'LBL_SAVE_TOOLTIP' => 'Save changes made in worksheet rows',
  'LBL_COMMIT_TOOLTIP_REP' => 'Save changes to records and submit forecast to manager',
  'LBL_COMMIT_TOOLTIP_MGR' => 'Submit forecast to manager and assign quota',
  'LBL_SAVE_LABEL_REP' => 'Save ',
  'LBL_SAVE_LABEL_MGR' => 'Save Adjusted Values',
