...
$mod_strings = array (
  ...
  'LBL_NO_DASHLETS_CONFIGURED' => 'No Dashlets Configured',
  ...
  'LBL_ABOUT_VERSION' => 'You are using version {{version}} with the following license(s):',
  'LBL_DASHBOARD_FILTERS' => 'Dashboard Filters',
  'LBL_NO_DASHBOARD_FILTER' => 'You have no dashboard filters.',
  'LBL_ADD_FILTER' => 'Add Filter',
  'LBL_SELECT_AVAILABLE_FILTERS' => 'Select available runtime filters to add to this dashboard filter.',
  'LBL_EDIT_FILTERS' => 'Edit Filters',
  'LBL_ONE_GROUP_REQUIRED' => 'Dashboard filters can not be empty. Please select a runtime filter, or remove the dashboard filter group before saving.',
  'LBL_NO_ALTER_FILTERS' => 'Please wait for the dashlets to fully load before using the dashboard filters.',
  'LBL_NO_EMPTY_GROUPS' => 'Please remove the empty dashboard filter or add a runtime filter to it.',
  'LBL_NO_PERMISSION_TO_FILTER' => 'You do not have permission to use this filter.',
  'LBL_DASHBOARD_DASHLETS_INCOMPATIBLE' => 'Feature not available with current dashlets.',
);