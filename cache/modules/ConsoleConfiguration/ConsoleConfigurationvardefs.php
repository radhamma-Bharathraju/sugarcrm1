<?php 
 $GLOBALS["dictionary"]["ConsoleConfiguration"]=array (
  ...
  array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'consoleconfiguration_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'consoleconfiguration_modified_user',
    ...
    array (
      'name' => 'activities',
      'type' => 'link',
      'relationship' => 'consoleconfiguration_activities',
    ...
    array (
      'name' => 'following_link',
      'type' => 'link',
      'relationship' => 'consoleconfiguration_following',
      'source' => 'non-db',
      'vname' => 'LBL_FOLLOWING',
      'reportable' => false,
    ),
    ...
    array (
      'name' => 'favorite_link',
      'type' => 'link',
      'relationship' => 'consoleconfiguration_favorite',
      'source' => 'non-db',
      'vname' => 'LBL_FAVORITE',
      'reportable' => false,
      'workflow' => false,
    ...
    array (
      ...
      'relationship' => 'consoleconfiguration_locked_fields',
      'source' => 'non-db',
      'exportable' => false,
      'duplicate_merge' => 'disabled',
    ),
  ...
  array (
    ...
    'consoleconfiguration_audit' => 
    array (
      'lhs_module' => 'ConsoleConfiguration',
      'lhs_table' => 'console_configuration',
      'lhs_key' => 'id',
      'rhs_module' => 'Audit',
      'rhs_table' => 'console_configuration_audit',
      'rhs_key' => 'parent_id',
      'relationship_type' => 'one-to-many',
    ),
  ),
  ...
  array (
    'id' => 
    array (
      'name' => 'idx_consoleconfiguration_pk',
      'type' => 'primary',
      'fields' => 
      array (
        0 => 'id',
    ...
    'date_modified' => 
    array (
      'name' => 'idx_console_configuration_del_d_m',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'deleted',
    ...
    'deleted' => 
    array (
      'name' => 'idx_console_configuration_id_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'id',
    ...
    'date_entered' => 
    array (
      'name' => 'idx_console_configuration_del_d_e',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'deleted',
    ...
    'name_del' => 
    array (
      'name' => 'idx_console_configuration_name_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'name',
    ...
    'sync_key' => 
    array (
      'name' => 'idx_console_configuration_skey',
      'type' => 'unique',
      'fields' => 
      array (
        0 => 'sync_key',
