...
$mod_strings = array (
  ...
  'LBL_LEAD_REDIRECT_REQUEST_TYPE' => 'Redirect Request Type',
  'LBL_LEAD_REDIRECT_REQUEST_TYPE_HELP' => 'Determines how the redirect will be performed.<br><br>GET: Redirects using a GET request, with any parameters being sent through the Redirect URL<br><br>POST: Redirects using a POST request, with any parameters being sent through the request body',
  'LBL_LEAD_REDIRECT_REQUEST_PARAMS_INCLUDE' => 'Include Form Results in Redirect',
  'LBL_LEAD_REDIRECT_REQUEST_PARAMS_INCLUDE_HELP' => 'Determines whether the resulting form values will be sent as parameters along with the request to the Redirect URL',
