<?php 
 $GLOBALS["dictionary"]["HintAccountset"]=array (
  ...
  array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'hintaccountsets_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'hintaccountsets_modified_user',
    ...
    array (
      'name' => 'activities',
      'type' => 'link',
      'relationship' => 'hintaccountset_activities',
    ...
    array (
      'name' => 'following_link',
      'type' => 'link',
      'relationship' => 'hintaccountsets_following',
      'source' => 'non-db',
      'vname' => 'LBL_FOLLOWING',
      'reportable' => false,
    ),
    ...
    array (
      'name' => 'favorite_link',
      'type' => 'link',
      'relationship' => 'hintaccountsets_favorite',
      'source' => 'non-db',
      'vname' => 'LBL_FAVORITE',
      'reportable' => false,
      'workflow' => false,
    ...
    array (
      ...
      'vname' => 'LBL_HINT_ACCOUNTSET_USER_ID',
    ...
    array (
      ...
      'vname' => 'LBL_HINT_ACCOUNTSET_USER_NAME',
      'rname' => 'full_name',
      'type' => 'relate',
      'reportable' => false,
      'source' => 'non-db',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'hintaccountsets_assigned_user',
    ...
    array (
      'name' => 'team_link',
      'type' => 'link',
      'relationship' => 'hintaccountsets_team',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'hintaccountsets_team_count_relationship',
      'link_type' => 'one',
      'module' => 'Teams',
      'bean_name' => 'TeamSet',
      'source' => 'non-db',
    ...
    array (
      'name' => 'teams',
      'type' => 'link',
      'relationship' => 'hintaccountsets_teams',
  ...
  array (
    ...
    'date_modified' => 
    array (
      'name' => 'idx_hint_accountsets_del_d_m',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'deleted',
    ...
    'deleted' => 
    array (
      'name' => 'idx_hint_accountsets_id_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'id',
    ...
    'date_entered' => 
    array (
      'name' => 'idx_hint_accountsets_del_d_e',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'deleted',
    ...
    'name_del' => 
    array (
      'name' => 'idx_hint_accountsets_name_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'name',
    ...
    'sync_key' => 
    array (
      'name' => 'idx_hint_accountsets_skey',
      'type' => 'unique',
      'fields' => 
      array (
        0 => 'sync_key',
    ...
    'assigned_user_id' => 
    array (
      'name' => 'idx_hint_accountsets_assigned_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'assigned_user_id',
    ...
    'team_set_hint_accountsets' => 
    array (
      'name' => 'idx_hint_accountsets_tmst_id',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'team_set_id',
    ...
    'acl_team_set_hint_accountsets' => 
    array (
      'name' => 'idx_hint_accountsets_acl_tmst_id',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'acl_team_set_id',
  ...
  array (
    ...
    'hintaccountsets_audit' => 
    array (
      'lhs_module' => 'HintAccountsets',
      'lhs_table' => 'hint_accountsets',
      'lhs_key' => 'id',
      'rhs_module' => 'Audit',
      'rhs_table' => 'hint_accountsets_audit',
      'rhs_key' => 'parent_id',
      'relationship_type' => 'one-to-many',
    ),
    ...
    'hintaccountsets_team_count_relationship' => 
    array (
      'lhs_module' => 'Teams',
      'lhs_table' => 'team_sets',
      'lhs_key' => 'id',
