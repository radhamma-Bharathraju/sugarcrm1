<?php 
 $GLOBALS["dictionary"]["DocuSignEnvelope"]=array (
  ...
  array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'docusignenvelopes_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'docusignenvelopes_modified_user',
    ...
    array (
      'name' => 'activities',
      'type' => 'link',
      'relationship' => 'docusignenvelope_activities',
    ...
    array (
      'name' => 'following_link',
      'type' => 'link',
      'relationship' => 'docusignenvelopes_following',
      'source' => 'non-db',
      'vname' => 'LBL_FOLLOWING',
      'reportable' => false,
    ),
    ...
    array (
      'name' => 'favorite_link',
      'type' => 'link',
      'relationship' => 'docusignenvelopes_favorite',
      'source' => 'non-db',
      'vname' => 'LBL_FAVORITE',
      'reportable' => false,
      'workflow' => false,
    ...
    array (
      'name' => 'team_link',
      'type' => 'link',
      'relationship' => 'docusignenvelopes_team',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'docusignenvelopes_team_count_relationship',
      'link_type' => 'one',
      'module' => 'Teams',
      'bean_name' => 'TeamSet',
      'source' => 'non-db',
    ...
    array (
      'name' => 'teams',
      'type' => 'link',
      'relationship' => 'docusignenvelopes_teams',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'docusignenvelopes_assigned_user',
  ...
  array (
    ...
    'date_modified' => 
    array (
      'name' => 'idx_docusign_envelopes_del_d_m',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'deleted',
    ...
    'deleted' => 
    array (
      'name' => 'idx_docusign_envelopes_id_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'id',
    ...
    'date_entered' => 
    array (
      'name' => 'idx_docusign_envelopes_del_d_e',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'deleted',
    ...
    'name_del' => 
    array (
      'name' => 'idx_docusign_envelopes_name_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'name',
    ...
    'sync_key' => 
    array (
      'name' => 'idx_docusign_envelopes_skey',
      'type' => 'unique',
      'fields' => 
      array (
        0 => 'sync_key',
    ...
    'team_set_docusign_envelopes' => 
    array (
      'name' => 'idx_docusign_envelopes_tmst_id',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'team_set_id',
    ...
    'acl_team_set_docusign_envelopes' => 
    array (
      'name' => 'idx_docusign_envelopes_acl_tmst_id',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'acl_team_set_id',
    ...
    'assigned_user_id' => 
    array (
      'name' => 'idx_docusign_envelopes_assigned_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'assigned_user_id',
  ...
  array (
    ...
    'docusignenvelopes_audit' => 
    array (
      'lhs_module' => 'DocuSignEnvelopes',
      'lhs_table' => 'docusign_envelopes',
      'lhs_key' => 'id',
      'rhs_module' => 'Audit',
      'rhs_table' => 'docusign_envelopes_audit',
      'rhs_key' => 'parent_id',
      'relationship_type' => 'one-to-many',
    ),
