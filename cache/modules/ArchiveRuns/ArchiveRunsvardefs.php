<?php 
 $GLOBALS["dictionary"]["ArchiveRuns"]=array (
  'table' => 'archive_runs',
  'archive' => false,
  'unified_search' => true,
  ...
  array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'archiveruns_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'archiveruns_modified_user',
    ...
    array (
      'name' => 'activities',
      'type' => 'link',
      'relationship' => 'archiveruns_activities',
    ...
    array (
      'name' => 'following_link',
      'type' => 'link',
      'relationship' => 'archiveruns_following',
      'source' => 'non-db',
      'vname' => 'LBL_FOLLOWING',
      'reportable' => false,
    ),
    ...
    array (
      'name' => 'favorite_link',
      'type' => 'link',
      'relationship' => 'archiveruns_favorite',
      'source' => 'non-db',
      'vname' => 'LBL_FAVORITE',
      'reportable' => false,
      'workflow' => false,
    ...
    array (
      ...
      'relationship' => 'archiveruns_locked_fields',
      'source' => 'non-db',
      'exportable' => false,
      'duplicate_merge' => 'disabled',
    ),
  ...
  array (
    ...
    'name_del' => 
    array (
      'name' => 'idx_archive_runs_name_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'name',
