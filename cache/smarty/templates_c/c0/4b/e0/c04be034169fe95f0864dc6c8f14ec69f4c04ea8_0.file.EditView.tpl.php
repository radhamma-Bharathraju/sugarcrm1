...
/* Smarty version 4.3.1, created on 2025-04-20 14:25:38
  from '/Users/radha/Sites/SugarEnt-copy/cache/modules/Schedulers/EditView.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.1',
  'unifunc' => 'content_680503e24afdc3_42216750',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'c04be034169fe95f0864dc6c8f14ec69f4c04ea8' => 
    array (
      0 => '/Users/radha/Sites/SugarEnt-copy/cache/modules/Schedulers/EditView.tpl',
      1 => 1745159138,
      2 => 'file',
    ),
  ),
...
function content_680503e24afdc3_42216750 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'/Users/radha/Sites/SugarEnt-copy/include/SugarSmarty/plugins/function.sugar_getjspath.php','function'=>'smarty_function_sugar_getjspath',),1=>array('file'=>'/Users/radha/Sites/SugarEnt-copy/include/SugarSmarty/plugins/function.sugar_csrf_form_token.php','function'=>'smarty_function_sugar_csrf_form_token',),2=>array('file'=>'/Users/radha/Sites/SugarEnt-copy/include/SugarSmarty/plugins/function.sugar_include.php','function'=>'smarty_function_sugar_include',),3=>array('file'=>'/Users/radha/Sites/SugarEnt-copy/vendor/smarty/smarty/libs/plugins/function.counter.php','function'=>'smarty_function_counter',),4=>array('file'=>'/Users/radha/Sites/SugarEnt-copy/include/SugarSmarty/plugins/function.sugar_translate.php','function'=>'smarty_function_sugar_translate',),5=>array('file'=>'/Users/radha/Sites/SugarEnt-copy/include/SugarSmarty/plugins/modifier.strip_semicolon.php','function'=>'smarty_modifier_strip_semicolon',),6=>array('file'=>'/Users/radha/Sites/SugarEnt-copy/vendor/smarty/smarty/libs/plugins/function.html_options.php','function'=>'smarty_function_html_options',),7=>array('file'=>'/Users/radha/Sites/SugarEnt-copy/include/SugarSmarty/plugins/modifier.lookup.php','function'=>'smarty_modifier_lookup',),8=>array('file'=>'/Users/radha/Sites/SugarEnt-copy/include/SugarSmarty/plugins/function.sugar_getimagepath.php','function'=>'smarty_function_sugar_getimagepath',),9=>array('file'=>'/Users/radha/Sites/SugarEnt-copy/vendor/smarty/smarty/libs/plugins/modifier.count.php','function'=>'smarty_modifier_count',),10=>array('file'=>'/Users/radha/Sites/SugarEnt-copy/include/SugarSmarty/plugins/function.sugar_help.php','function'=>'smarty_function_sugar_help',),11=>array('file'=>'/Users/radha/Sites/SugarEnt-copy/include/SugarSmarty/plugins/function.sugar_getimage.php','function'=>'smarty_function_sugar_getimage',),));
?>
...
if (!empty($_REQUEST['return_action']) && $_REQUEST['return_action'] == "DetailView" && !empty($_smarty_tpl->tpl_vars['fields']->value['id']['value']) && empty($_REQUEST['return_id'])) {?>parent.SUGAR.App.router.buildRoute('<?php echo rawurlencode((string)$_REQUEST['return_module']);?>
', '<?php echo rawurlencode((string)$_smarty_tpl->tpl_vars['fields']->value['id']['value']);?>
', '<?php echo rawurlencode((string)$_REQUEST['return_action']);?>
')<?php } elseif (!empty($_REQUEST['return_module']) || !empty($_REQUEST['return_action']) || !empty($_REQUEST['return_id'])) {?>parent.SUGAR.App.router.buildRoute('<?php echo rawurlencode((string)$_REQUEST['return_module']);?>
', '<?php echo rawurlencode((string)$_REQUEST['return_id']);?>
', '<?php echo rawurlencode((string)$_REQUEST['return_action']);?>
...
:
            ...
            <?php }?>
				...
				<?php echo smarty_function_counter(array('name'=>"fieldsUsed"),$_smarty_tpl);?>
		            ...
		            <?php if (($_smarty_tpl->tpl_vars['fields']->value['name']['acl'] > 1 || 'name' == 'license_type') && $_smarty_tpl->tpl_vars['fields']->value['name']['locked'] == false && $_smarty_tpl->tpl_vars['fields']->value['name']['disabled'] == false) {?>
...
:
            ...
            <?php }?>
				...
				<?php echo smarty_function_counter(array('name'=>"fieldsUsed"),$_smarty_tpl);?>
		            ...
		            <?php if (($_smarty_tpl->tpl_vars['fields']->value['status']['acl'] > 1 || 'status' == 'license_type') && $_smarty_tpl->tpl_vars['fields']->value['status']['locked'] == false && $_smarty_tpl->tpl_vars['fields']->value['status']['disabled'] == false) {?>
...
.queryDelay = 0;
		SUGAR.AutoComplete.<?php echo $_smarty_tpl->tpl_vars['ac_key']->value;?>
.numOptions = <?php echo smarty_modifier_count($_smarty_tpl->tpl_vars['field_options']->value);?>
;
...
:
            ...
            <?php }?>
				...
				<?php echo smarty_function_counter(array('name'=>"fieldsUsed"),$_smarty_tpl);?>
		            ...
		            <?php if (($_smarty_tpl->tpl_vars['fields']->value['job_function']['acl'] > 1 || 'job_function' == 'license_type') && $_smarty_tpl->tpl_vars['fields']->value['job_function']['locked'] == false && $_smarty_tpl->tpl_vars['fields']->value['job_function']['disabled'] == false) {?>
...
:
            ...
            <?php }?>
				...
				<?php echo smarty_function_counter(array('name'=>"fieldsUsed"),$_smarty_tpl);?>
		            ...
		            <?php if (($_smarty_tpl->tpl_vars['fields']->value['job_url']['acl'] > 1 || 'job_url' == 'license_type') && $_smarty_tpl->tpl_vars['fields']->value['job_url']['locked'] == false && $_smarty_tpl->tpl_vars['fields']->value['job_url']['disabled'] == false) {?>
...
:
            ...
            <?php }?>
				...
				<?php echo smarty_function_counter(array('name'=>"fieldsUsed"),$_smarty_tpl);?>
		            ...
		            <?php if (($_smarty_tpl->tpl_vars['fields']->value['adv_interval']['acl'] > 1 || 'adv_interval' == 'license_type') && $_smarty_tpl->tpl_vars['fields']->value['adv_interval']['locked'] == false && $_smarty_tpl->tpl_vars['fields']->value['adv_interval']['disabled'] == false) {?>
...
:
            ...
            <?php }?>
				...
				<?php echo smarty_function_counter(array('name'=>"fieldsUsed"),$_smarty_tpl);?>
		            ...
		            <?php if (($_smarty_tpl->tpl_vars['fields']->value['job_interval']['acl'] > 1 || 'job_interval' == 'license_type') && $_smarty_tpl->tpl_vars['fields']->value['job_interval']['locked'] == false && $_smarty_tpl->tpl_vars['fields']->value['job_interval']['disabled'] == false) {?>
...
<?php }?>
  ...
  <div id="detailpanel_2" class="<?php echo (($tmp = $_smarty_tpl->tpl_vars['def']->value['templateMeta']['panelClass'] ?? null)===null||$tmp==='' ? 'edit view edit508' ?? null : $tmp);?>
">
...
:
		...
		<?php echo smarty_function_sugar_help(array('text'=>$_smarty_tpl->tpl_vars['MOD']->value['LBL_CATCH_UP_WARNING']),$_smarty_tpl);?>
		            ...
		            <?php if (($_smarty_tpl->tpl_vars['fields']->value['catch_up']['acl'] > 1 || 'catch_up' == 'license_type') && $_smarty_tpl->tpl_vars['fields']->value['catch_up']['locked'] == false && $_smarty_tpl->tpl_vars['fields']->value['catch_up']['disabled'] == false) {?>
...
:
            ...
            <?php }?>
				...
				<?php echo smarty_function_counter(array('name'=>"fieldsUsed"),$_smarty_tpl);?>
		            ...
		            <?php if (($_smarty_tpl->tpl_vars['fields']->value['date_time_start']['acl'] > 1 || 'date_time_start' == 'license_type') && $_smarty_tpl->tpl_vars['fields']->value['date_time_start']['locked'] == false && $_smarty_tpl->tpl_vars['fields']->value['date_time_start']['disabled'] == false) {?>
...
", "<?php echo strtr((string)$_smarty_tpl->tpl_vars['TIME_FORMAT']->value, array("\\" => "\\\\", "'" => "\\'", "\"" => "\\\"", "\r" => "\\r", 
                       "\n" => "\\n", "</" => "<\/", "<!--" => "<\!--", "<s" => "<\s", "<S" => "<\S",
                       "`" => "\\`", "\${" => "\\\$\{"));?>
", "0", '', false, true);
...
_date",
	ifFormat : "<?php echo strtr((string)$_smarty_tpl->tpl_vars['CALENDAR_FORMAT']->value, array("\\" => "\\\\", "'" => "\\'", "\"" => "\\\"", "\r" => "\\r", 
                       "\n" => "\\n", "</" => "<\/", "<!--" => "<\!--", "<s" => "<\s", "<S" => "<\S",
                       "`" => "\\`", "\${" => "\\\$\{"));?>
",
	daFormat : "<?php echo strtr((string)$_smarty_tpl->tpl_vars['CALENDAR_FORMAT']->value, array("\\" => "\\\\", "'" => "\\'", "\"" => "\\\"", "\r" => "\\r", 
                       "\n" => "\\n", "</" => "<\/", "<!--" => "<\!--", "<s" => "<\s", "<S" => "<\S",
                       "`" => "\\`", "\${" => "\\\$\{"));?>
",
...
_trigger",
	...
	step : 1,
	weekNumbers: false,
        startWeekday: <?php echo (($tmp = strtr((string)$_smarty_tpl->tpl_vars['CALENDAR_FDOW']->value, array("\\" => "\\\\", "'" => "\\'", "\"" => "\\\"", "\r" => "\\r", 
                       "\n" => "\\n", "</" => "<\/", "<!--" => "<\!--", "<s" => "<\s", "<S" => "<\S",
                       "`" => "\\`", "\${" => "\\\$\{")) ?? null)===null||$tmp==='' ? '0' ?? null : $tmp);?>
,
...
:
            ...
            <?php }?>
				...
				<?php echo smarty_function_counter(array('name'=>"fieldsUsed"),$_smarty_tpl);?>
		            ...
		            <?php if (($_smarty_tpl->tpl_vars['fields']->value['time_from']['acl'] > 1 || 'time_from' == 'license_type') && $_smarty_tpl->tpl_vars['fields']->value['time_from']['locked'] == false && $_smarty_tpl->tpl_vars['fields']->value['time_from']['disabled'] == false) {?>
...
:
            ...
            <?php }?>
				...
				<?php echo smarty_function_counter(array('name'=>"fieldsUsed"),$_smarty_tpl);?>
		            ...
		            <?php if (($_smarty_tpl->tpl_vars['fields']->value['date_time_end']['acl'] > 1 || 'date_time_end' == 'license_type') && $_smarty_tpl->tpl_vars['fields']->value['date_time_end']['locked'] == false && $_smarty_tpl->tpl_vars['fields']->value['date_time_end']['disabled'] == false) {?>
...
:
            ...
            <?php }?>
				...
				<?php echo smarty_function_counter(array('name'=>"fieldsUsed"),$_smarty_tpl);?>
		            ...
		            <?php if (($_smarty_tpl->tpl_vars['fields']->value['time_to']['acl'] > 1 || 'time_to' == 'license_type') && $_smarty_tpl->tpl_vars['fields']->value['time_to']['locked'] == false && $_smarty_tpl->tpl_vars['fields']->value['time_to']['disabled'] == false) {?>
